...
if not os.path.exists('results/clip_captionword_GOLD_RETEXISTS_ACCK'):
    os.mkdir('results/clip_captionword_GOLD_RETEXISTS_ACCK')
...
with open('full_pb_clip_captionword_GOLD_RETEXISTS_ACCK.txt', 'w') as f:
...
torch.save(chain_rank_scores, 'results/clip_captionword_GOLD_RETEXISTS_ACCK/full_pb_clip_captionword_GOLD_RETEXISTS_ACCK_chain_rank_scores.pt')
