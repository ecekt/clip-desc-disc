...
ttest_ind = ttest_ind
# CLIP Listener GOLD
results_file = 'results/clip_listener_ENTROPY_GOLD/full_pb_cliplistener_ENTROPY_GOLD_chain_rank_scores.pt'
