...
# CLIPSCORE COSINE
results_file = 'results/clipscore_TMM/full_pb_clipscore_TMM_chain_rank_scores.pt'
...
print('CLIPSCORE COSINE TMM Utterance rank 0 vs. 1 for descriptiveness')
pvalue = ttest_ind(chain_rank_scores[0], chain_rank_scores[1]).pvalue
print('ttest ind', 'pvalue', round(pvalue, 6), '\n')

print('CLIPSCORE COSINE TMM Utterance rank 0 vs. 2 for descriptiveness')
pvalue = ttest_ind(chain_rank_scores[0], chain_rank_scores[2]).pvalue
print('ttest ind', 'pvalue', round(pvalue, 6), '\n')

print('CLIPSCORE COSINE TMM Utterance rank 0 vs. 3 for descriptiveness')
pvalue = ttest_ind(chain_rank_scores[0], chain_rank_scores[3]).pvalue
print('ttest ind', 'pvalue', round(pvalue, 6), '\n')

print('CLIPSCORE COSINE TMM Utterance rank 1 vs. 2 for descriptiveness')
pvalue = ttest_ind(chain_rank_scores[1], chain_rank_scores[2]).pvalue
print('ttest ind', 'pvalue', round(pvalue, 6), '\n')

print('CLIPSCORE COSINE TMM Utterance rank 1 vs. 3 for descriptiveness')
pvalue = ttest_ind(chain_rank_scores[1], chain_rank_scores[3]).pvalue
print('ttest ind', 'pvalue', round(pvalue, 6), '\n')

print('CLIPSCORE COSINE TMM Utterance rank 2 vs. 3 for descriptiveness')
