...
if not os.path.exists('results/clip_captionword_GOLD_ISOLATED_RETEXISTS'):
    os.mkdir('results/clip_captionword_GOLD_ISOLATED_RETEXISTS')
...
with open('full_pb_clip_captionword_GOLD_ISOLATED_RETEXISTS.txt', 'w') as f:
...
torch.save(chain_rank_scores, 'results/clip_captionword_GOLD_ISOLATED_RETEXISTS/full_pb_clip_captionword_GOLD_ISOLATED_RETEXISTS_chain_rank_scores.pt')
